<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="books.login1" %>
      ...
      <div class="row">
        <div class="col-md-6 ">
          ...
          <form id="form1" runat="server">
            ...
            <div >
                <asp:Label ID="loginlbl" runat="server" Font-Bold="True" ForeColor="Red" Visible="False"></asp:Label>
                <asp:Button ID="btn1" runat="server" Text="log in" OnClick="btn1_Click" BackColor="#0066CC" Font-Bold="True" ForeColor="White" />
            </div>
          </form>
        </div>
        <div class="col-md-6">
